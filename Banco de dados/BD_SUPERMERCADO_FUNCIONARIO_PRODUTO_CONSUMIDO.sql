CREATE DATABASE IF NOT EXISTS BD_SUPERMERCADO_FUNCIONARIO_PRODUTO_CONSUMIDO;
...
CREATE TABLE IF NOT EXISTS CONSUMIDOR(
    ...
    CON_TELEPHONE VARCHAR(15) NOT NULL,
...
CREATE TABLE IF NOT EXISTS FUNCIONARIO(
    ...
    FUN_TELEPHONE VARCHAR(15) NOT NULL,
    FUN_EMAIL VARCHAR(100) NOT NULL,
    FUN_CARTEIRA_DE_TRABALHO BLOB,
